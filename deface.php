...
<head>
	<title>Hacked By D3VIL_404</title>
	<meta charset="UTF-8">
    <audio src="https://cdn.prinsh.com/data-1/mp3/best-hacker-music.mp3"  autoplay="1" loop="1"></audio>
	<meta name="Author" content="PH4N70M 30YZ"/>
...
<br>
<br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] HLW...ADMIN.</font> <br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] I AM</font><font style="color:red; font-family: "font-effect-neon";>  D3VIL_404</font><br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] YOUR WEBSITE HAS BEEN HACKED BY</font><br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] <font style="color:red;font-family:Nosifer;text-shadow:#000 0px 0px 3px">D3VIL_404</font><font style="color:white;text-shadow:#000 0px 0px 3px">  HAHAHA...</font>  [+]         </font> <br>
					 <font color="White"> 
...
TypingText.runAll();
    ...
    <style> 
      ...
      A:Hover, A:Visited:Hover , A.no:Hover
, A.no:Visited:Hover
...
<center>
<h2 class="glow"><font style="color:green;text-shadow:#000 0px 0px 3px"></font><font style="color:red;text-shadow:#000 0px 0px 3px">TEAM </font><font style="color:white;text-shadow:#000 0px 0px 3px">PH4N70M 30YZ</font>
...
<h2 class="glow2" ><font style="color:yellow;text-shadow:#000 0px 0px 3px">.::Hacked By D3VIL_404::.</font><br> <span style="color:orange;font-family:Iceland;text-shadow:white 0px 0px 10px">./</span><span style="color:#ffffff;font-family:Iceland;text-shadow:#FF0099 0px 0px 10px">PH4N70M 30YZ</span></b></h2>
<p><b><font style="color:green;text-shadow:#000 0px 0px 3px">Sorry Admin, I Was On Your System. By </font><span style="font-family:Iceland;color:red;text-shadow:#000 0px 0px 3px">D3VIL_404 ,</span>
		...
		<span style="font-family:Iceland;font-weight:bold;color:#ffffff"><p><font style="color:green;text-shadow:#000 0px 0px 3px">~Special Greetz To~</font></p></span>
	</div>
...
<b>-=| Team PH4N70M 30YZ| 4LPH43V1L | User_Superman_X | Rajput_Haxor | D3VIL_404 | Anon D46k Phantom | Dar4k Rappto | A7 TOC | D46K 596 | Team Black Dragonsec | and to You |=-</font>
</marquee>
</td>
</table></div> 
<div class="fot">
Copyrights &copy; PH4N70M
</div>
</center>
</body>
